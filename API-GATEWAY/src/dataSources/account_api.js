...
class AccountAPI extends RESTDataSource {
    ...
    async createVentas(ventas) {
        ventas = new Object(JSON.parse(JSON.stringify(ventas)));
        return await this.post('/ventas', ventas);
    }
    
    async ventasByUsername(username) {
        return await this.get(`/ventas/${username}`);
    }
}
